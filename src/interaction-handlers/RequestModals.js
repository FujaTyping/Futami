const { InteractionHandler, InteractionHandlerTypes, container } = require('@sapphire/framework');
...
class RequestModalHandler extends InteractionHandler {
    ...
    async run(interaction) {
        ...
        const Content = new EmbedBuilder()
            .setColor(color)
            .setAuthor({ name: 'ส่งแบบฟอร์มเรียบร้อยแล้ว !!', iconURL: 'https://futami.siraphop.me/assets/icon/checked.png' })
            .setDescription('ขอบคุณที่ให้คำแนะนำฟูตามิ , เราจะพัฒนาฟูตามิให้ดียิ่งขั้น 🩵')
            .setTimestamp()
