  ...
  async chatInputRun(interaction) {
    ...
    const Game = new FastType({
      ...
      embed: {
        ...
        color: colorHex,
        description:
          "⏰ มีเวลา **{time} วินาที** ที่จะพิมพ์ประโยคด้านล่างและส่งให้ทันเวลา !!",
      },
      timeoutTime: Math.round(
        Math.floor(Math.random() * (60001 - 30000 + 1)) + 30000,
      ),
      sentence: RandomWords.join(" "),
      winMessage:
        "🎉 ชนะแล้ว !! , พิมพ์เป็นเวลา **{time} วินาที** และพิมพ์ **{wpm} คำต่อนาที** (WPM)",
      loseMessage:
        "💢 ไม่นะ แพ้ได้ไง ?? , ไม่ได้พิมพ์ประโยคที่ถูกต้องในเวลาที่กำหนด\n**ทิปการเล่น** : มี วรรณวรรค ให้ วรรณวรรคด้วย เช่นเดี่ยวกับตัวเลข ❤",
    });
