...
class AboutCommand extends Command {
    ...
    async chatInputRun(interaction) {
        ...
        const Content = new EmbedBuilder()
            ...
            .setDescription('ฟูตามิเป็นบอทเพลงที่สร้างขึ้นโดย [FujaTyping](https://siraphop.me/) เพื่อตอบสนองคำขอของ **ph007phop** เพื่อนสนิทของเขา ฟูตามิสามารถเปิดเพลงจากแหล่งต่างๆ ได้มากมายและได้รับความนิยมอย่างรวดเร็วในหมู่ผู้ใช้ Discord')
            .setTimestamp()
